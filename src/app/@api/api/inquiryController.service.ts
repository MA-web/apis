...
export class InquiryControllerService {
    ...
    /**
     * get Approved inquiry By deal Id
     * 
     * @param dealId dealId
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getLastApprovedInquiryUsingGET(dealId: number, observe?: 'body', reportProgress?: boolean): Observable<InquiryVersionResponseDto>;
    public getLastApprovedInquiryUsingGET(dealId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InquiryVersionResponseDto>>;
    public getLastApprovedInquiryUsingGET(dealId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InquiryVersionResponseDto>>;
    public getLastApprovedInquiryUsingGET(dealId: number, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

        if (dealId === null || dealId === undefined) {
            throw new Error('Required parameter dealId was null or undefined when calling getLastApprovedInquiryUsingGET.');
        }
        ...
        return this.httpClient.get<InquiryVersionResponseDto>(`${this.basePath}/api/inquiries/${encodeURIComponent(String(dealId))}/last-approved-inquiry`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
