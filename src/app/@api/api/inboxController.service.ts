...
export class InboxControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public markChatAsReadUsingPUT(chatId: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public markChatAsReadUsingPUT(chatId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public markChatAsReadUsingPUT(chatId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public markChatAsReadUsingPUT(chatId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (chatId === null || chatId === undefined) {
            throw new Error('Required parameter chatId was null or undefined when calling markChatAsReadUsingPUT.');
        }
