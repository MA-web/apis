...
export class QuotationControllerService {
     ...
     */
    public acceptQuotationUsingPUT(quotationId: number, quotationVersionReplyDto: QuotationVersionReplyDto, observe?: 'body', reportProgress?: boolean): Observable<QuotationVersionDto>;
    public acceptQuotationUsingPUT(quotationId: number, quotationVersionReplyDto: QuotationVersionReplyDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<QuotationVersionDto>>;
    public acceptQuotationUsingPUT(quotationId: number, quotationVersionReplyDto: QuotationVersionReplyDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<QuotationVersionDto>>;
    public acceptQuotationUsingPUT(quotationId: number, quotationVersionReplyDto: QuotationVersionReplyDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (quotationVersionReplyDto === null || quotationVersionReplyDto === undefined) {
            throw new Error('Required parameter quotationVersionReplyDto was null or undefined when calling acceptQuotationUsingPUT.');
        }
        ...
        return this.httpClient.put<QuotationVersionDto>(`${this.basePath}/api/quotations/${encodeURIComponent(String(quotationId))}/accept`,
    ...
    /**
     * get Approved quotation By deal Id
     * 
     * @param dealId dealId
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getLastApprovedQuotationUsingGET(dealId: number, observe?: 'body', reportProgress?: boolean): Observable<QuotationVersionDto>;
    public getLastApprovedQuotationUsingGET(dealId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<QuotationVersionDto>>;
    public getLastApprovedQuotationUsingGET(dealId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<QuotationVersionDto>>;
    public getLastApprovedQuotationUsingGET(dealId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (dealId === null || dealId === undefined) {
            throw new Error('Required parameter dealId was null or undefined when calling getLastApprovedQuotationUsingGET.');
        }
        ...
        return this.httpClient.get<QuotationVersionDto>(`${this.basePath}/api/quotations/${encodeURIComponent(String(dealId))}/last-approved-quotation`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getQuotationByIdUsingGET1(quotationId: number, observe?: 'body', reportProgress?: boolean): Observable<QuotationResponseDto>;
    public getQuotationByIdUsingGET1(quotationId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<QuotationResponseDto>>;
    public getQuotationByIdUsingGET1(quotationId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<QuotationResponseDto>>;
    public getQuotationByIdUsingGET1(quotationId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (quotationId === null || quotationId === undefined) {
            throw new Error('Required parameter quotationId was null or undefined when calling getQuotationByIdUsingGET1.');
        }
    ...
    /**
     * reject Quotation from supplier
     * 
     * @param quotationId quotationId
     * @param quotationVersionReplyDto quotationVersionReplyDto
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public rejectQuotationUsingPUT(quotationId: number, quotationVersionReplyDto: QuotationVersionReplyDto, observe?: 'body', reportProgress?: boolean): Observable<QuotationVersionDto>;
    public rejectQuotationUsingPUT(quotationId: number, quotationVersionReplyDto: QuotationVersionReplyDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<QuotationVersionDto>>;
    public rejectQuotationUsingPUT(quotationId: number, quotationVersionReplyDto: QuotationVersionReplyDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<QuotationVersionDto>>;
    public rejectQuotationUsingPUT(quotationId: number, quotationVersionReplyDto: QuotationVersionReplyDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (quotationVersionReplyDto === null || quotationVersionReplyDto === undefined) {
            throw new Error('Required parameter quotationVersionReplyDto was null or undefined when calling rejectQuotationUsingPUT.');
        }
        ...
        return this.httpClient.put<QuotationVersionDto>(`${this.basePath}/api/quotations/${encodeURIComponent(String(quotationId))}/reject`,
            quotationVersionReplyDto,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
