...
import { ItemCategoryDto, NewsControllerService, ItemDto, PageItemDto, PublicDataControllerService, NewsDto, PageNewsDto } from 'src/app/@api';
...
export class NewsListComponent extends AppBaseComponent implements OnInit , OnDestroy{
  ...
  getList() {
    ...
    const getFavSub = this._newsControllerService.getAdminNewsUsingGET(this.pageNumber,this.pageSize).subscribe((res: PageNewsDto) => {
      if (res) {
